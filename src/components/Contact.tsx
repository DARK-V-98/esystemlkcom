...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-secondary/30 to-background text-foreground relative overflow-hidden animate-fade-in opacity-0">
