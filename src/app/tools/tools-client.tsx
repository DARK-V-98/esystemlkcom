...
const allTools: Tool[] = [
  { icon: 'FileSignature', title: 'Advanced Invoice Builder', description: 'Create and download professional, brand-ready PDF invoices for your clients in seconds.', category: 'Business', link: '/tools/invoice-generator', style: 'primary' },
  ...
  { icon: 'Server', title: 'Advanced Website Uptime Checker', description: 'Instantly verify if your website is online and responsive world-wide with status codes.', category: 'Web', link: '/tools/uptime-checker', style: 'primary' },
  { icon: 'Terminal', title: 'Advanced API Tester', description: 'A lightweight, browser-based client to test your API endpoints. A free, high-performance Postman alternative.', category: 'Web', link: '/tools/api-tester', style: 'secondary' },
  { icon: 'Barcode', title: 'Advanced Barcode Generator', description: 'Create standard barcodes (EAN, UPC, CODE128) for products or inventory management instantly.', category: 'Utility', link: '/tools/barcode-generator', style: 'outline' },
  ...
  { icon: 'Braces', title: 'Advanced JSON ⇄ CSV Converter', description: 'Convert JSON files to CSV and vice-versa seamlessly. Supports nested JSON and large file uploads.', category: 'Converter', link: '/tools/json-csv-converter', style: 'outline' },
  ...
  { icon: 'ShieldCheck', title: 'Advanced SSL Certificate Checker', description: "Check a domain's SSL certificate for expiry, issuer, and cryptographic health instantly.", category: 'Security', link: '/tools/ssl-checker', style: 'primary' },
  ...
  { icon: 'Minimize', title: 'Advanced Image Compressor', description: 'Reduce image file size up to 90% without quality loss. Supports JPEG and WebP formats.', category: 'Image', link: '/tools/image-compressor', style: 'primary' },
  ...
  { icon: 'AppWindow', title: 'Premium Favicon Generator', description: 'Create a complete set of favicons for all devices (Android, iOS, Desktop) from a single image.', category: 'Design', link: '/tools/favicon-generator', style: 'primary' },
  ...
  { icon: 'Tags', title: 'Advanced SEO Meta Tag Generator', description: 'Generate robust meta tags for title, description, and social media with live SERP previews.', category: 'Web', link: '/tools/meta-tag-generator', style: 'primary' },
  { icon: 'Bot', title: 'Advanced Robots.txt Generator', description: 'Create and download a custom `robots.txt` file to guide search engine crawlers and boost SEO.', category: 'Web', link: '/tools/robots-txt-generator', style: 'secondary' },
  { icon: 'Network', title: 'Advanced Sitemap Generator', description: 'Generate an XML sitemap from a list of URLs to improve your site\'s professional SEO indexing.', category: 'Web', link: '/tools/sitemap-xml-generator', style: 'outline' },
